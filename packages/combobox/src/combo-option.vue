...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      ...
      selectOptionClick() {
        if (this.disabled !== true && this.groupDisabled !== true) {
          ...
          this.dispatch('Combobox', 'handleOptionClick', this);  //增加调用combobox by wangjingl@sunline.cn
        }
      },
    ...
    beforeDestroy() {
      ...
      this.dispatch('Combobox', 'onOptionDestroy', this);  //增加调用combobox by wangjingl@sunline.cn
    }
  };
</script>